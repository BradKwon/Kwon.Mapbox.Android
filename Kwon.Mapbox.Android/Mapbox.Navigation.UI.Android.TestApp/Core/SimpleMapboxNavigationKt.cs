...
namespace MapboxNavigation.UI.Droid.TestApp.Core
{
        ...
        IFasterRouteObserver
    {
        ...
        {
            private readonly long countDownInterval;
            private readonly ProgressBar fasterRouteAcceptProgress;
            private readonly float maxProgress;
            ...
            public FasterRouteSelectionTimer(long millisInFuture, long countDownInterval,
                ProgressBar fasterRouteAcceptProgress, float maxProgress)
                    : this(millisInFuture, countDownInterval)
            {
                this.countDownInterval = countDownInterval;
                this.fasterRouteAcceptProgress = fasterRouteAcceptProgress;
