...
namespace MapboxNavigation.UI.Droid.TestApp.Core
{
    ...
    //                Utils.Utils.GetMapboxAccessToken(this), cache);
    ...
    //                    .AccessToken(Utils.Utils.GetMapboxAccessToken(Application.Context))
    ...
    //            .DefaultNavigationOptionsBuilder(this, Utils.Utils.GetMapboxAccessToken(this));
    ...
    //        if (originalRoute != null)
    //        {
    //            outState.PutString(Utils.Utils.PRIMARY_ROUTE_BUNDLE_KEY, originalRoute.ToJson());
    //        }
    //    }
    ...
    //        originalRoute = Utils.Utils.GetRouteFromBundle(savedInstanceState);
    //    }
